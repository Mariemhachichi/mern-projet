...
const Animaux = () => {
    ...
    <div>
        ...
        <h1>Réservez vos services <br /> de garde d’animaux <br /> ponctuelles ou <br />récurrentes
</h1>
        </div>
        <img src="https://d1b747rczec55w.cloudfront.net/assets/categories/24v-fddfccd74d69615df3578d73963b53cfaf7d15bfec41e6338907eb3a06a2567f.svg" alt="img" className="imgb"/>
        </div>
        <hr className="hr" />
        <ul className="ull">
        ...
        <div className="cart">
            {Object.keys(usersData).filter(el=>usersData[el].metier==="Animaux").map((el,key) => (
